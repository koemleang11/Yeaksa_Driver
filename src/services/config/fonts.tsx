...
export const PoppinRegular = fontMaker({
  weight: 'Regular',
  family: 'Poppins',
  familyIOS: 'Poppins-Regular',
});

export const PoppinMedium = fontMaker({
  weight: 'Medium',
  family: 'Poppins',
  familyIOS: 'Poppins-Medium',
});
export const PoppinSemiBold = fontMaker({
  weight: 'SemiBold',
  family: 'Poppins',
  familyIOS: 'Poppins',
});
export const PoppinBold = fontMaker({
  weight: 'Bold',
  family: 'Poppins',
  familyIOS: 'Poppins-Bold',
});
