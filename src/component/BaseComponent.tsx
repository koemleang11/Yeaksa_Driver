    ...
    return (
        <>
            ...
            <HStack style={{
                ...
                {
                    props.disabledTranstate ? <Text style={styles.title}>{props.title}</Text>
                        : <TextTranslate style={styles.title}>{props.title}</TextTranslate>
                }
                {
                    props.enabledAdd ? <TouchableOpacity onPress={props.onAdd} style={styles.button}>
                        <AntDesign name='pluscircleo' size={screenWidth(28)} color={colors.mainColor} />
                    </TouchableOpacity> :
