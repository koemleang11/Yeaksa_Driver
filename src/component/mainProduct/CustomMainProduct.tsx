    ...
    return (
        <View style={{
            ...
            {state.routes.map((route: any, index: any) => {
                ...
                return (
                    <TouchableOpacity
                        style={{ ...styles.button, backgroundColor: isFocused ? colors.mainColor : colors.lowOpacityMain }}
                    ...
                    >
                        {
                            index == 0 ? <>
                                ...
                                }}>products</TextTranslate>
                                <Text style={{ ...styles.value, color: isFocused ? colors.white : colors.mainColor }}>288</Text>
                            </> : <>
                                <TextTranslate style={{
                                    ...styles.title,
                                    color: isFocused ? colors.lightGrayColor : colors.mainColor
                                }}>reviews</TextTranslate>
                                <FontAwesome name='star' size={screenWidth(30)} color={isFocused ? colors.white : colors.mainColor} />
                            </>
                        }
                    </TouchableOpacity>
                );
