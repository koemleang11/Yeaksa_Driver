...
const AboutUsScreen = () => {
    ...
    return (
        <BaseComponent title='about_us' style={styles.container} disabledCloseKeyboard>
            <ScrollView showsVerticalScrollIndicator={false}>
                <Box style={{ ...styles.whiteBox, marginBottom: screenWidth(20) + insets.bottom }}>
                    ...
                    <Image source={{uri: 'https://www.cloudways.com/blog/wp-content/uploads/Top-Ecommerce-Websites.jpg'}} style={styles.image} />
                    <Text style={styles.title}>Who do we supply?</Text>
                    <Text style={styles.text}>Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using content here, content here, making it look like readable English. Many desktop publishing packages and web page.</Text>
                    <Image source={{uri: 'https://blog-frontend.envato.com/cdn-cgi/image/width=1200,quality=85,format=auto/uploads/2022/04/E-commerce-App-JPG-File-scaled.jpg'}} style={styles.image} />
                    <Text style={styles.title}>Why us?</Text>
                    <Text style={styles.text}>Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using content here, content here, making it look like readable English. Many desktop publishing packages and web page.</Text>
                    <Image source={{uri: 'https://ocdn.eu/images/pulscms/ZjI7MDA_/bb6b0f53264a0ae1d90067153c065aeb.jpg'}} style={styles.image} />
                    <Text style={styles.text}>Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using content here, content here, making it look like readable English. Many desktop publishing packages and web page.</Text>
                </Box>
            </ScrollView>
        </BaseComponent>
