...
const ProductScreen = () => {
    ...
    useEffect(() => {
        classificationState?.length > 0 && setClassification(classificationState[0])
    }, [classificationState]);
    ...
    return (
        <View style={styles.container}>
            ...
            {
                (loadMoreState || refreshing) ? <ProductLoading />
                    : productState?.listing?.length === 0 ? <NoData title='empty_product' />
                        : <FlatListVertical
